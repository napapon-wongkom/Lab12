...
int calScore(int x,int y,int z){
	...
	//Return the score. 
	int sumscore = cardScores[x] + cardScores[y] + cardScores[z];
	int score = sumscore%10;
	return score;
}
...
int main(){	
	...
	if(playerAction == 1){
		...
		int thirdcard = drawCard();
		playerScore = (playerScore+cardScores[thirdcard])%10;
		cout << "Player draws the 3rd card!!!" << "\n";
		cout << "Your 3rd card: "<< cardNames[thirdcard] << "\n";
	...
	if(yugiAction == 1){
		int thirdcardyugi = drawCard();
		yugiScore = (yugiScore+cardScores[thirdcardyugi])%10;
		cout << "Yugi draws the 3rd card!!!\n";
		cout << "Yugi's 3rd card: "<< cardNames[thirdcardyugi] << "\n";
